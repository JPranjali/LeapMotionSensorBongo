...
ConnectedHand.prototype.leapToScene1 = function( position ){
  ...
  function manupulator(position){
    ...
    if((position[0]>20 && position[0] <= 30)||(position[1]>-22 && position[1] <= -12)&&(position[2]>-150 && position[2] <= -160))
     {//document.getElementById("audio").src='sounds/e2.mp3';
                  document.getElementById("audio1").play();
                 // r.innerText=posString+"audio1";
    }
    if((position[0]>26 && position[0] <= 36)||(position[1]>9 && position[1] <= 19)&&(position[2]>-145 && position[2] <= -155))
     {//document.getElementById("audio").src='sounds/e2.mp3';
                  document.getElementById("audio2").play();
                //  r.innerText=posString+"audio2";
    }
    if((position[0]>-62 && position[0] <= -52)||(position[1]>-23 && position[1] <= -12)&&(position[2]>-143 && position[2] <= -133))
     {//document.getElementById("audio").src='sounds/e2.mp3';
                  document.getElementById("audio3").play();
                //  r.innerText=posString+"audio3";
    }
    if((position[0]>-54 && position[0] <= -44)||(position[1]>6 && position[1] <= 16)&&(position[2]>-140 && position[2] <= -130))
     {//document.getElementById("audio").src='sounds/e2.mp3';
                  document.getElementById("audio4").play();
                //  r.innerText=posString+"audio4";
    }
